...
For [Kakfa](https://kafka.apache.org/), use [bilel/kafka-docker](https://github.com/bilel/kafka-docker) project, a clone of the [wurstmeister/kafka-docker](https://github.com/wurstmeister/kafka-docker) project. The `bilel/kafka-docker` [local docker-compose file](https://github.com/bilel/kafka-docker/blob/master/docker-compose-local.yml) builds a Kafka, Kafka Manager, ZooKeeper, MongoDB, Eureka Server, and Zuul.
